...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("快速儲存") action QuickSave()
            textbutton _("快速讀取") action QuickLoad()
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("第{}頁"), auto=_("自動儲存"), quick=_("快速儲存"))
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("回滾操作")
                    textbutton _("禁用回滾") action Preference("rollback side", "disable")
                    textbutton _("屏幕左邊") action Preference("rollback side", "left")
                    textbutton _("屏幕右邊") action Preference("rollback side", "right")
                ...
                vbox:
                    ...
                    textbutton _("過場動畫") action InvertSelected(Preference("transitions", "toggle"))
...
screen help():
    ...
    use game_menu(_("說明"), scroll="viewport"):
